...
void Camera::viewmat(GLuint shaderprog){
    int view_mat_location = glGetUniformLocation (shaderprog, "view");
    glUseProgram (shaderprog);
    glUniformMatrix4fv(view_mat_location, 1, GL_FALSE, &view()[0][0]);
}

void Camera::promat(GLuint shaderprog){
    int proj_mat_location = glGetUniformLocation (shaderprog, "proj");
    glUseProgram (shaderprog);
